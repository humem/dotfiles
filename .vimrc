...
" https://moyapro.com/2018/04/02/disable-ime-on-wsl-vim/
" Insertモードを抜けるときに日本語IMEをオフにする
function! s:isWsl()
...
if s:isWsl() && executable('AutoHotkeyU64.exe')
    augroup insertLeave
        autocmd!
        autocmd InsertLeave * :call system('AutoHotkeyU64.exe "C:\Users\owner\Apps\ImDisable.ahk"')
    augroup END
endif
