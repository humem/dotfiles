	       ...
	       (and (file-readable-p (expand-file-name file))
		    (list (if (string-match "\\.sdic$" file)
				...
				'sdic-compat
			      'sdic-gene))
			  file)))
	     '("/Users/Shared/dict/lib/gene.sdic"))) "\
	       ...
	       (and (file-readable-p (expand-file-name file))
		    (list (if (string-match "\\.sdic$" file)
				...
				'sdic-compat
			      'sdic-gene))
			  file)))
	     '("/Users/Shared/dict/lib/jedict.sdic"))) "\
*Options of an English-Japanese dictionary.
和英辞典の検索メソッドのリストを指定する変数")

(setq sdic-eiwa-dictionary-list
	(append sdic-eiwa-dictionary-list
	'((sdicf-client "/Users/Shared/dict/lib/eijirou.sdic"))))

(setq sdic-waei-dictionary-list
	(append sdic-waei-dictionary-list
	'((sdicf-client "/Users/Shared/dict/lib/waeijirou.sdic"))))
